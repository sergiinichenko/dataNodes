# -*- coding: utf-8 -*-
"""
A module containing the intersecting nodes functionality. 
If a node gets dragged and dropped on an existing edge
...
class EdgeIntersect:
    ...
    def update(self, scene_pos_x: float, scene_pos_y: float):
        ...
        for grItem in grItems:
            if hasattr(grItem, 'edge') and not self.draggedNode.hasEdge(grItem.edge):
